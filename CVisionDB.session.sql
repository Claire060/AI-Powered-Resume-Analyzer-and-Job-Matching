...
-- Sample data for shortlisted_candidates table
INSERT INTO shortlisted_candidates (resume_id, recruiter_id, shortlisted_date, notes) VALUES
(7, 1, '2023-11-01 09:30:00', 'Candidate has relevant skills and experience.'),
(8, 2, '2023-11-02 11:00:00', 'Strong candidate for Data Scientist role with impressive qualifications.'),
(9, 1, '2023-11-05 14:00:00', 'Lacks experience in software development but could be trained.'),
(10, 3, '2023-11-06 16:30:00', 'Good fit for the Project Manager role due to leadership experience.'),
(11, 2, '2023-11-10 10:15:00', 'Excellent communication skills but lacking technical expertise.');

-- Sample data for resume_analysis table
INSERT INTO resume_analysis (resume_id, recruiter_id, match_score, analysis_date, status, notes) VALUES
(7, 1, 85, '2023-11-01 10:00:00', 'processed', 'Matches well with the role. Strong programming skills in Python and Java.'),
(8, 2, 90, '2023-11-02 12:00:00', 'processed', 'Great fit for Data Scientist position with strong background in data analytics and machine learning.'),
(9, 1, 55, '2023-11-05 15:00:00', 'processed', 'Not a strong match, lacks relevant experience in software development.'),
(10, 3, 78, '2023-11-06 17:00:00', 'processed', 'Good leadership skills, but lacks technical knowledge for the role.'),
(11, 2, 60, '2023-11-10 11:00:00', 'processed', 'Lacking technical expertise but has strong communication skills for managerial roles.');
